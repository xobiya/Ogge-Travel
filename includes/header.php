                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="relative group cursor-pointer">
                        ...
                        <div class="absolute right-0 mt-3 w-52 bg-[#0a0f1e] rounded-xl shadow-2xl border border-white/10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right scale-95 group-hover:scale-100 overflow-hidden z-50">
                            <div class="p-2">
                                <a href="/profile" class="flex items-center px-4 py-3 text-xs font-semibold tracking-wider uppercase text-white/70 hover:text-[#c9a96e] hover:bg-white/5 rounded-lg transition-colors" style="font-family:'Inter',sans-serif;">
                                ...
                                <a href="/my-bookings" class="flex items-center px-4 py-3 text-xs font-semibold tracking-wider uppercase text-white/70 hover:text-[#c9a96e] hover:bg-white/5 rounded-lg transition-colors" style="font-family:'Inter',sans-serif;">
...
<div id="globalSearchOverlay" class="fixed inset-0 z-[100] bg-[#0a0f1e]/98 backdrop-blur-2xl hidden opacity-0 transition-all duration-500 flex flex-col items-center justify-center p-6">
    ...
    <div class="w-full max-w-3xl transform scale-95 transition-transform duration-500" id="searchContent">
        ...
        <div class="mt-12 flex flex-wrap justify-center gap-4">
            ...
            <a href="/search?q=Lalibela" class="px-5 py-2 rounded-full border border-white/10 text-white/50 text-[10px] font-bold uppercase tracking-widest hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all">Lalibela</a>
            <a href="/search?q=Omo" class="px-5 py-2 rounded-full border border-white/10 text-white/50 text-[10px] font-bold uppercase tracking-widest hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all">Omo Valley</a>
            <a href="/search?q=Simien" class="px-5 py-2 rounded-full border border-white/10 text-white/50 text-[10px] font-bold uppercase tracking-widest hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all">Simien Mountains</a>
        </div>
    </div>
</div>
